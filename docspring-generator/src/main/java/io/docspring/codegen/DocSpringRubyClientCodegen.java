...
public class DocSpringRubyClientCodegen extends RubyClientCodegen {
    @Override
    public String getName() {
        return "docspring-ruby";
    }
    ...
    public void processOpts() {
        ...
        supportingFiles.add(new SupportingFile("client.rb", gemFolder, "api/client.rb"));
        supportingFiles.add(new SupportingFile("pdf_api_integration_spec.rb", "spec/api/pdf_api_integration_spec.rb"));
        supportingFiles.add(new SupportingFile("client_integration_spec.rb", "spec/api/client_integration_spec.rb"));
    }
